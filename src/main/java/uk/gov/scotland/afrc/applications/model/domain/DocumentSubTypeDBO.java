...
public class DocumentSubTypeDBO implements Serializable, BaseTableAware {
    ...
    private DocumentTypeDBO documentType;
    ...
    public DocumentTypeDBO getDocumentType() {
        return documentType;
    }

    public void setDocumentType(DocumentTypeDBO documentType) {
