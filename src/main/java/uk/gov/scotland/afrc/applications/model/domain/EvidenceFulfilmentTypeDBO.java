...
@Table(name = "EVDNCE_FULFILMENT_TYPE")
@javax.persistence.Cacheable
public class EvidenceFulfilmentTypeDBO implements Serializable, BaseTableAware {
    ...
    public String toString() {
        return "EvidenceFulfilmentType [baseTable=" + baseTable + ", code=" + code + ", businessPriority="
