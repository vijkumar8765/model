...
/**
 * The persistent class for the QUESTION_MANDATORY_TYPE database table.
 * 
 */
@Entity
@Table(name="QUESTION_MANDATORY_TYPE")
@javax.persistence.Cacheable
public class QuestionMandatoryTypeDBO implements Serializable {
	...
	public QuestionMandatoryTypeDBO() {
	}
