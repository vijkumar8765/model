...
@Entity
@Table(name = "VALIDATION_TYPE_CLASS")
@EntityListeners(BaseTableListener.class)
public class ValidationTypeClassDBO implements Serializable, BaseTableAware {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ValidationTypeClassDBO other = (ValidationTypeClassDBO) obj;
		if (name == null) {
			if (other.name != null)
				return false;
	...
	public String toString() {
        return "ValidationTypeClassDBO [jpaVersionNumber=" + jpaVersionNumber + ", baseTable=" + baseTable + ", code="
